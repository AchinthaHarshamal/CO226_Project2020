...
(null, 'Jack Wikramsinha','No.3 Street2 Colombo','0112527744','M',12,'C003','D00013','2020-12-14','09:00:00'),
(null, 'Imash B Disanayaka','No.12 Street1 Paliyagoda','0112486434','M',22,'C004','D00012','2020-09-15','14:00:00'),
(null, 'Siri Angel','No.111 Street6 Kurunagala','0989090956','M',30,'C017','D00004','2020-12-31','16:00:00'),
(null, 'Beauty F Kooler','No.24 Street2 Kandy','0764946684','M',16,'C011','D00002','2020-12-06','16:00:00'),
(null, 'R.M. Roopawathi','No.206 Street4 Gampaha','0716598648','F',37,'C012','D00011','2020-11-03','08:30:00'),
(null, 'K.D.M. tiger','No.29 Street3 Badulla','0729868646','M',56,'C010','D00001','2020-12-06','08:00:00'),
(null, 'Don F Latmer','No.25 Street2 Mathara','0114897642','M',34,'C003','D00009','2020-11-03','14:00:00'),
(null, 'Sam Abewardana ','No.1 Street1 Kurunagala','0112325372','M',34,'C001','D00011','2020-12-06','14:30:00'),
(null, 'G.Gillai','No.20 Street3 Gampaha','0115948776','F',28,'C015','D00018','2020-06-14','17:30:00'),
(null, 'Udaree K walwita','No.10 Street6 Anuradapura','0112556499','F',27,'C016','D00019','2020-11-03','17:30:00'),
(null, 'K.D.H.Lal','No.2 Street12 Rathnapura','0786565688','M',48,'C018','D00001','2020-12-14','16:00:00'),
(null, 'Rooper S Donlad','No.36 Street3 Kuliyapitiya','0112911450','M',29,'C001','D00017','2020-11-03','17:00:00'),
(null, 'D.M. Walisundara','No.25 Street2 Mathara','0779482264','F',36,'C010','D00004','2020-04-14','14:00:00'),
(null, 'K.M. Kulasooriya','No.45 Street2 Kandy','0715583266','F',67,'C018','D00010','2020-12-14','13:30:00'),
(null, 'Jane Fernando','No.2 Street3 Gampaha','0115756321','F',26,'C005','D00010','2020-12-25','10:00:00'),
(null, 'K.Justin','No.100 Street64 Anuradapura','0753659485','M',30,'C012','D00003','2020-11-03','16:30:00'),
(null, 'Silly Bimily','No.2 Street4 Negombo','0114290869','F',36,'C006','D00016','2020-11-04','16:00:00'),
(null, 'Jill Rock','No.2 Street1 Colombo','0774561234','M',23,'C002','D00003','2020-10-03','13:00:00'),
(null, 'J.S.Joopat','No.108 Street1 Kurunagala','0706592956','M',59,'C009','D00007','2020-10-12','17:00:00'),
(null, 'Chery S Doom','No.2 Street6 Galle','0112420696','M',45,'C002','D00008','2020-11-12','17:30:00');


CREATE VIEW doctorView AS
SELECT d.doctorID, c.Name, c.CenterID, COUNT(AppID) AS AppCount FROM Appointment a,doctor d ,channelcenter c
WHERE d.doctorID = a.DoctorID AND c.CenterID = a.CenterID
GROUP BY c.CenterID;

CREATE VIEW CenterDoctor_view as
SELECT d.Name as DocName, a.CenterID, PName, AppDate, AppTime, Room FROM Doctor d, Appointment a, Visits v 
WHERE a.DoctorID = d.DoctorID AND a.DoctorID = v.DoctorID AND a.CenterID = v.CenterID;
