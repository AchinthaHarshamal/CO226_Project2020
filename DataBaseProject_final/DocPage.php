...
.vertical-center {
  ...
  transform: translate(-50%, -50%);
    ...
    <hr width="100%" style="height:2px;border-width:0;color:white;background-color:white">
    <br>
     <p  class="Welcome">Hello doctor!</p> 
    ...
    <div class="grid-container">
        <div class="grid-child b1">
            ...
            <form action="DocView.php" method="post" ><tr>
            <th><h3 style="color:white">&nbsp;&nbsp;&nbsp;&nbsp;Enter your Doc ID:</h3></th>
            <br>
            <th style="text-align: left; color:white;"><input id="SearchInput" class="vertical-center" type="text" name="DoctorID"/><br><br>
